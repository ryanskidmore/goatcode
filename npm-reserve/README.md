...
ochead is a professionally-engineered OpenCode plugin that provides:
...
- TypeScript-native configuration (`ochead.config.ts`)
...
- [GitHub](https://github.com/ryanskidmore/oc-head)
