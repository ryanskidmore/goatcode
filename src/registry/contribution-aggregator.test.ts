    ...
    const plugins: PluginDefinition[] = [
      {
        name: "a",
        agents: {
          shared: makeAgentContribution("model-a"),
          keep: makeAgentContribution("model-a"),
        },
      },
      {
        name: "b",
        agents: {
          shared: makeAgentContribution("model-b"),
          skip: makeAgentContribution("model-b"),
        },
      },
    ];

    const aggregated = aggregateContributions<"agents", PluginAgentContribution>(
      plugins,
      "agents",
      {
        disabled: ["skip"],
