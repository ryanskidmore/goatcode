...
let rulesTransformHandler: PluginHookContributions["experimental.chat.system.transform"] | null =
  null;

const combinedToolAfterHandler: PluginHookContributions["tool.execute.after"] = async (
  input,
  output,
) => {
