...
const SAMPLE_AGENTS: AgentTableEntry[] = [
  { name: "explorer", description: "Searches the codebase for patterns.", whenToUse: "Need to find code references" },
  { name: "deep-worker", description: "Autonomous implementation agent.", whenToUse: "Complex multi-file changes" },
  { name: "advisor", description: "Read-only architecture consultant.", whenToUse: "Design decisions and debugging" },
]
    ...
    describe("#when called with agents", () => {
      ...
      it("#then truncates descriptions at the first period", () => {
        ...
        const agents: AgentTableEntry[] = [
          { name: "test-agent", description: "First sentence. Second sentence.", whenToUse: "Always" },
        ]
