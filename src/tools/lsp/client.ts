...
async function callMethod(methodOwner: JsonRecord, methodName: string, args: JsonRecord): Promise<unknown> {
...
async function callToolExecutor(toolHost: unknown, toolName: string, args: JsonRecord): Promise<unknown> {
